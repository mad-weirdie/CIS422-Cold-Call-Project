...
class Controller:
    ...
    def import_roster(self, initial_import=False):
        ...
        if not error:
            ...
            names = [f"{student.first_name} {student.last_name}" for student in students_who_will_be_changed]
            proceed = True
            ...
            messagebox.showwarning(message=f"Cannot import roster file. {error}")
